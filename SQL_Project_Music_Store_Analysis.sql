...
SELECT c.City, SUM(inv.Total) AS Totals
FROM Customer c
...
SELECT c.customer_id, c.first_name, c.last_name, SUM(inv.total) AS total_spending
FROM customer c 
JOIN invoice inv
...
WITH best_selling_artist AS (
    ...
    JOIN album2 alb ON alb.album_id = track.album_id
